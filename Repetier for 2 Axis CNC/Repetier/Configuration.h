...
#define XAXIS_STEPS_PER_MM 80 //For A4988 Stepper Drivers
/** \brief Number of steps for a 1mm move in y direction.
For xy gantry use 2*belt moved!
Overridden if EEPROM activated.*/
#define YAXIS_STEPS_PER_MM 80 //For A4988 Stepper Drivers
/** \brief Number of steps for a 1mm move in z direction  Overridden if EEPROM activated.*/
#define ZAXIS_STEPS_PER_MM 4000 //For DRV8825 Stepper Drivers
#endif
...
#define MIN_DEFECT_TEMPERATURE 1		// FIS200115 -10 -> 1
#define MAX_DEFECT_TEMPERATURE 280
...
#define FEATURE_WATCHDOG false		// FIS200115 true -> false
...
#define UI_PRINTER_NAME "My First Prusa i3"
#define UI_PRINTER_COMPANY "AATHIF INNOVATION LABS"


/** Animate switches between menus etc. */
#define UI_ANIMATION false  //true  --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
#define UI_SET_PRESET_HEATED_BED_TEMP_ABS 125
